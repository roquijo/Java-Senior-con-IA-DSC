...
# Sugerencia de distribución de las 2 horas

| Tiempo | Contenido |
|--------|-----------|
| 0:00 – 0:25 | Parte 1: Introducción a Stream, características, flujo, cómo crear streams. |
| 0:25 – 1:00 | Parte 2: Operaciones intermedias (filter, map, sorted, distinct, limit, skip) con ejemplos en vivo o en IDE. |
| 1:00 – 1:35 | Parte 3: Operaciones terminales (forEach, collect, count, findFirst, reduce) con ejemplos. |
| 1:35 – 1:50 | Parte 4: Comparación imperativo vs funcional; cuándo usar cada enfoque. |
| 1:50 – 2:00 | Parte 5: Ejemplo completo (Persona) y 1–2 ejercicios rápidos en clase o para casa. |

Puedes ajustar los tiempos según el ritmo del grupo; si sobra tiempo, ampliar la práctica con más ejercicios del apartado 5.2.
